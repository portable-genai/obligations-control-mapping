...
ENV PYTHONDONTWRITEBYTECODE=1 \
    ...
    OBLIGATIONS_PROFILE=gcp \
    OBLIGATIONS_SETTINGS=/app/config/settings.yaml \
    PORT=8080
...
CMD ["sh", "-c", "exec uvicorn obligations_control_mapping.api.app:app --host 0.0.0.0 --port ${PORT:-8080}"]
