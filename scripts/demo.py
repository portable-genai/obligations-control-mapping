...
from obligations_control_mapping.domain import (
    kernel,
    models,
)
...
from obligations_control_mapping.ports.generation import GenerationRequest
...
SERVICE_NAME = "Obligations to Control Mapping"
CATALOG_ID = "obligations-control-mapping"
REPOSITORY = "obligations-control-mapping"
...
def _exit_generation(container: Any) -> Any:
    return container.generation.generate(
        GenerationRequest(
            system="restate the coverage figures",
            prompt="Facts: covered=1, partial=1, uncovered=1.",
            facts=(("covered", "1"), ("partial", "1"), ("uncovered", "1")),
        )
    )
