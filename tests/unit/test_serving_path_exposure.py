...
``OBLIGATIONS_S2S_TOKEN`` used to switch the guard off under a DELIBERATE
...
from obligations_control_mapping.api.app import (
    app,
)
...
_IAP_AUDIENCE_ENV = "OBLIGATIONS_IAP_AUDIENCE"
...
_API_MODULE = "obligations_control_mapping.api.app"
