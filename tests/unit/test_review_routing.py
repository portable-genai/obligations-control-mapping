...
from obligations_control_mapping.adapters.gcp.review_router import (
    CloudReviewRouter,
)
from obligations_control_mapping.adapters.local.review_router import (
    LocalReviewRouter,
)
from obligations_control_mapping.adapters.onprem.review_router import (
    OnPremReviewRouter,
)
...
from obligations_control_mapping.domain.kernel import (
    Severity,
)
