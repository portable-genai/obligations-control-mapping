...
from obligations_control_mapping.adapters.gcp.identity import IapIdentityAdapter
...
def _adapter_module() -> object:
    ...
    return importlib.import_module("obligations_control_mapping.adapters.gcp.identity")
