...
read
    ...
    bind_profile == local AND profile chosen AND OBLIGATIONS_S2S_TOKEN unset
...
from obligations_control_mapping.adapters.gcp.identity import (
    IapIdentityAdapter,
)
from obligations_control_mapping.adapters.local.identity import (
    LocalIdentityAdapter,
)
from obligations_control_mapping.adapters.onprem.identity import (
...
from obligations_control_mapping.ports.identity import (
    CLIENT_ASSERTED,
    END_USER_AUTH_ATTR,
    END_USER_AUTH_KINDS,
    UNIMPLEMENTED,
