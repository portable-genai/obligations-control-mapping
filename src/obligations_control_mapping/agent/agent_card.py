...
class AgentCard:
    ...
    provider: str = "obligations-control-mapping"
...
_DESCRIPTION = " ".join(
    (
        "Obligations to Control Mapping",
        "(Rgc7).",
...
def build_agent_card(settings: Settings | None = None) -> AgentCard:
    ...
    return AgentCard(
        name="obligations-control-mapping",
...
def _resolve_url(settings: Settings) -> str:
    ...
    return f"https://obligations-control-mapping.{settings.region}.internal.example/a2a"
